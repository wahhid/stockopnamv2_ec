...
function insertstock($row,$periode){
    $query = "INSERT INTO stockbin (dc,periode,warehouse,pid,storagetype,itemno,storagebin,quantno,site,storageloc,articleno,description,batchno,stkcat,specialstock,countedqty,counteduom) VALUES (" .
            "'" . $_SESSION['dc'] . "'," .
            $periode . "," .
            "'" . $row[0] . "'," .
            isempty($row[1]) . "," .
