...
function inserttransstockdetail($qty){
    ...
    if($sequence['success']){       
        if($_SESSION['batchno']!=''){
            $query = "INSERT INTO transstockdetail (sequence,transstock,batchno,product,transdate,qty1,qty2,status,createddate,createdby,updateddate,updatedby,bin) VALUES (" .
                 $sequence['data'] . "," .
                 $_SESSION['transstock'] . "," .
                 "'" . $_SESSION['batchno'] . "'," .
                 "'" . $_SESSION['ean'] . "'," .
...
function updatetransstokdetail($qty){
    if($_SESSION['periodesession'] == 1){
        $query = "UPDATE transstockdetail SET batchno='" . $_SESSION['batchno'] . "',qty1=" .  $qty . ",qty2=" . $qty . ",bin=" . $_SESSION['binname'] . " WHERE transstock=" . $_SESSION['transstock'] . " AND product='" . $_SESSION['ean'] ."'";        
    }else{
        $query = "UPDATE transstockdetail SET batchno='" . $_SESSION['batchno'] . "',qty2=" . $qty . ",bin=" . $_SESSION['binname'] . " WHERE transstock=" . $_SESSION['transstock'] . " AND product='" . $_SESSION['ean'] ."'";        
    }
