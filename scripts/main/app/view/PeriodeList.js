Ext.define('App.view.PeriodeList' ,{
    ...
    initComponent: function() {    
        ...
        var stockbinstore = Ext.create('Ext.data.Store', {    
            fields: ['warehouse','pid','storagetype','itemno','storagebin','quantno','dc','storageloc','articleno','description','batchno','stkcat','specialstock','countedqty','counteduom','stocksap','deff'],             
            autoSync: true,
            remoteFilter: true,
            pageSize: 10,
            proxy: {
        ...
        var stockgrid = Ext.create('Ext.grid.Panel',{
            ...
            columns: [                   
				...
				{header: 'Diff', dataIndex: 'deff', flex: 1}
